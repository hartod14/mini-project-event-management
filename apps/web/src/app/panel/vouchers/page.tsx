...
import PanelVoucherListViewModel from '@/components/panel/pages/vouchers/list/PanelVoucherListViewModel';
import { MagnifyingGlassIcon } from '@heroicons/react/24/outline';

export default function PanelVoucher() {
  const {
    router,
    table,
    page,
  ...
  return (
    ...
    <div className="flex justify-between">
      ...
      <div className="flex gap-2">
        <ButtonList
          onAdd={() => {
            router.push('/panel/vouchers/add');
          }}
        />
      </div>
    </div>
