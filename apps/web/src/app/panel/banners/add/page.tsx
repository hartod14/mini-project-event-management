...
import { createBanner } from '@/helpers/handlers/apis/banner.api';
...
export default function PanelAddBanner() {
  const {
    isLoading,
    loading,
    router,
            ...
            if (result.isConfirmed) {
              try {
                ...
                if (res?.error) {
                  ...
                  Swal.fire({
                    title: 'Saved!',
                    text: 'Your new banner has been created.',
                    icon: 'success',
                    confirmButtonColor: '#3085d6',
                  }).then(() => {
